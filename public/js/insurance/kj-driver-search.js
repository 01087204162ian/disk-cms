...
(function () {
  ...
  document.addEventListener('click', (e) => {
    const companyTrigger = e.target.closest('[data-role="open-company-modal"]');
    if (companyTrigger) {
      e.preventDefault();
      e.stopPropagation();
      const companyNum = companyTrigger.dataset.companyNum;
      const companyName = companyTrigger.dataset.companyName;
      if (companyNum) {
